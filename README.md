...
I used a decision tree classifier with randomized hyperparameter search for optimization. The model achieved >97% recall while maintaining interpretability. Several feature engineering attempts were explored to capture different fraud patterns, and the optimal combination was discovered empirically using backward feature selection.
